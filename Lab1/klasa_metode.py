...
class Metode:
    ...
    def Inverz(self):  #koristimo stupce iz P kao vrijednosti vektora b; na kraju on postaje stupac inverzne matrice
    ...
    def Determinanta(self):  #det(A) = det(P^-1) * det(L) * det(U)
